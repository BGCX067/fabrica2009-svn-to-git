...
public class BusinessDelegateReposicionArticulos extends Model {
	
	private Facade facade = null;
	private InitialContext initialContext = null;
	private String naming = "zaraEAR/SessionFacade/remote";
	private Logger logger = Logger.getLogger(BusinessDelegateReposicionArticulos.class);

	public BusinessDelegateReposicionArticulos() {
		inicializarContexto();
	}
	...
	public ArrayList<ArticuloEnListadoVO> calculaArticulosPorCD() {
		...
		if (facade != null){
			return obtenerFacade().calculaArticulosPorCD();
		}
		return null;
	}
