...
public class BusinessDelegateEnvioProveedores extends Model {
	
	private Facade facade = null;
	private InitialContext initialContext = null;
	private String naming = "zaraEAR/SessionFacade/remote";
	private Logger logger = Logger.getLogger(BusinessDelegateEnvioProveedores.class);
	

	public BusinessDelegateEnvioProveedores() {
		inicializarContexto();
	}
	...
	public ArrayList<MateriaPrimaVO> procesarEnvioProveedores(ArrayList<MateriaPrimaVO> materiasPrimas) {
		...
		if (facade != null){
			return facade.procesarEnvioProveedores(materiasPrimas);
		}
		return null;
	}
